...
return [
  ...
  */
  'drivers' => [
    ...
    'n-genius' => [
      'apiPurchaseUrl' => 'https://bpm.shaparak.ir/pgwchannel/startpay.mellat',
      'accessTokenUrl' => 'https://identity.ngenius-payments.com/auth/realms/networkinternational/protocol/openid-connect/token',
      'apiPayStart' => 'https://api-gateway.ngenius-payments.com/transactions/outlets/:outletId/orders',
      'payUrl' => 'https://paypage.ngenius-payments.com',

      'apiKey' => env('PAYMENT_N_GENIUS_API'),
      'outletId' => env('PAYMENT_N_GENIUS_OUTLEDT_ID'),
      'callbackUrl' => env('PAYMENT_N_GENIUS_CALLBACK_URL'),
  ...
  */
  'map' => [
    ...
    'n-genius' => \App\Drivers\PaymentDriver\NGenius\NGeniusDriver::class,
  ],
];
