...
class HowWorkController extends Controller
{
  ...
  public function update(Request $request)
  {
    ...
    Session::flash('success', 'Update How Work Section successfully!');
  ...
  public function store(EventFeatureRequest $request)
  {
    ...
    Session::flash('success', 'New How it Work Item added successfully!');
  ...
  public function update_feature(EventFeatureRequest $request)
  {
    ...
    Session::flash('success', 'Event How it Work Item updated successfully!');
  ...
  public function delete($id)
  {
    ...
    return redirect()->back()->with('success', 'How it Work Item deleted successfully!');
  }
  public function bulk_delete(Request $request)
  {
    ...
    Session::flash('success', 'How it Work Items deleted successfully!');
