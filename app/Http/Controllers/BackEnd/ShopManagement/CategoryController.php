...
class CategoryController extends Controller
{
  ...
  public function update_featured(Request $request, $id)
  {
    ...
    if ($request->is_feature == 1) {
      Session::flash('success', 'Product category featured successfully!');
    } else {
      Session::flash('warning', 'Product category unfeatured successfully!');
    }
  ...
  public function bulk_delete(Request $request)
  {
    ...
    Session::flash('success', 'Product categories are deleted successfully!');
    return response()->json(['status' => 'success'], 200);
  }
}
