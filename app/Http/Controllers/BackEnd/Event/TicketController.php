...
class TicketController extends Controller
{
  public function index(Request $request)
  {
    ...
    $event = EventContent::where('event_id', $request->event_id)->where('language_id', $language->id)->firstOrFail();
  ...
  public function create(Request $request)
  {
    ...
    $eventType = Event::where('id', $request->event_id)->select('event_type')->firstOrFail();
  ...
  public function store(TicketRequest $request)
  {
    ...
    Session::flash('success', 'Event Ticket added successfully!');
