...
class EventBookingController extends Controller
{
  ...
  public function show($id)
  {
    ...
    $eventContent = EventContent::where('event_id', $booking->event_id)->where('language_id', $language->id)->firstOrFail();
    $eventTitle = $eventContent->title;

    return view('organizer.event.booking.details', compact('booking', 'eventTitle'));
  }
