                      ...
                      <div class="row align-items-center">
                        <div class="col-lg-9">
                          <div class="order-info">
                            ...
                            <p><b>{{ __('Order Date') . ' : ' }}</b> {{ date('d-M-Y', strtotime($order->created_at)) }}
                            </p>
                          </div>
                        </div>
                        <div class="col-lg-3">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="main-info">
                          ...
                          <ul class="list">
                            ...
                            <li>
                              <p><b>{{ __('Email') . ' : ' }} </b>{{ $order->billing_email }}</p>
                            </li>
                            <li>
                              <p><b>{{ __('Phone') . ' : ' }}</b>{{ $order->billing_phone }}</p>
                            </li>
                            <li>
                              <p><b>{{ __('Country') . ' : ' }} </b>{{ $order->billing_country }}</p>
                            </li>
                            <li>
                              <p><b>{{ __('State') . ' : ' }}</b>{{ $order->billing_state }}</p>
                            </li>
                            <li>
                              <p><b>{{ __('City') . ' : ' }} </b>{{ $order->billing_city }}</p>
                            </li>
                            <li>
                              <p><b>{{ __('Zip-code') . ' : ' }} </b>{{ $order->billing_zip_code }}</p>
                            </li>
                            <li>
                              <p><b>{{ __('Address') . ' : ' }} </b> {{ $order->billing_address }}</p>
                            </li>
                          </ul>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="main-info">
                          ...
                          <ul class="list">
                            <li>
                              <p><b>{{ __('Name') . ' : ' }} </b>{{ $order->shipping_fname }}
                                {{ $order->shipping_lname }}</p>
                            </li>
                            <li>
                              <p><b>{{ __('Email') . ' : ' }} </b>{{ $order->shipping_email }}</p>
                            </li>
                            <li>
                              <p><b>{{ __('Phone') . ' : ' }} </b>{{ $order->shipping_phone }}</p>
                            </li>
                            <li>
                              <p><b>{{ __('Country') . ' : ' }} </b>{{ $order->shipping_country }}</p>
                            </li>
                            <li>
                              <p><b>{{ __('State') . ' : ' }} </b>{{ $order->shipping_state }}</p>
                            </li>
                            <li>
                              <p><b>{{ __('City') . ' : ' }} </b>{{ $order->shipping_city }}</p>
                            </li>
                            <li>
                              <p><b>{{ __('Zip-code') . ' : ' }} </b>{{ $order->shipping_zip_code }}</p>
                            </li>
                            <li>
                              <p><b>{{ __('Address') . ' : ' }} </b> {{ $order->shipping_address }}</p>
                            </li>
                            <li>
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="payment-information">
                          ...
                          @endif
                          <p><b>{{ __('Payment Method') . ' : ' }}</b> {{ __($order->method) }}</p>
                        </div>
                      </div>
                    </div>
                  </div>
                        ...
                        @if (count($order_items) > 0)
                          @foreach ($order_items as $item)
                            <tr>
                              ...
                              <td>{{ \Illuminate\Support\Str::limit($item->title, 35, $end = '...') }}</td>
                              <td>{{ $item->sku }}</td>
                              <td>{{ $item->qty }}</td>
                              <td>{{ $order->currency_symbol_position == 'left' ? $order->currency_symbol : '' }}
                                {{ $item->price }}
                                {{ $order->currency_symbol_position == 'right' ? $order->currency_symbol : '' }}</td>
                            </tr>
                          @endforeach
                        @else
