                      ...
                      <div class="row align-items-center">
                        <div class="col-lg-9">
                          <div class="order-info">
                            ...
                            <p><b>{{ __('Booking Date') . ' : ' }}</b> {{ FullDateTime($booking->created_at) }}</p>
                            <p><b>{{ __('Event Start Date') . ' : ' }}</b> {{ FullDateTime($booking->event_date) }}</p>
                          </div>
                        </div>
                        <div class="col-lg-3">
                          <div class="prinit">
                    ...
                    <div class="row">
                      <div class="col-md-4">
                        <div class="main-info">
                          ...
                          <ul class="list">
                            <li>
                              <p><b>{{ __('Name') . ' : ' }}</b>{{ $booking->fname }} {{ $booking->lname }}</p>
                            </li>
                            <li>
                            ...
                            <li>
                              <p><b>{{ __('Country') . ' : ' }} </b>{{ $booking->country }}</p>
                            </li>
                            <li>
                            ...
                            <li>
                              <p><b>{{ __('Zip-code') . ' : ' }} </b>{{ $booking->zip_code }}</p>
                            </li>
                            <li>
                              <p><b>{{ __('Address') . ' : ' }} </b> {{ $booking->address }}</p>
                            </li>
                          </ul>
                        </div>
                      </div>
                      ...
                      <div class="col-md-4">
                        <div class="payment-information">
                          ...
                          <p><b>{{ __('Payment Method') . ' : ' }}</b> {{ __($booking->paymentMethod) }}</p>
                          @if (is_null($booking->variation))
                            <p><b>{{ __('Quantity') . ' : ' }}</b> {{ __($booking->quantity) }}</p>
                          @endif
                        </div>
                      </div>
                      @if ($booking->organizer)
                        <div class="col-md-4">
                          <div class="payment-information">
                            ...
                            <p><b>{{ __('Email') . ' : ' }}</b> {{ @$booking->organizer->email }}</p>
                            <p><b>{{ __('Phone') . ' : ' }}</b> {{ @$booking->organizer->phone }}</p>
                            <p><b>{{ __('City') . ' : ' }}</b> {{ @$booking->organizer->organizer_info->city }}</p>
                            <p><b>{{ __('State') . ' : ' }}</b> {{ @$booking->organizer->organizer_info->state }}</p>
                            <p><b>{{ __('Country') . ' : ' }}</b> {{ @$booking->organizer->organizer_info->country }}
                            </p>
                            <p><b>{{ __('Address') . ' : ' }}</b> {{ @$booking->organizer->organizer_info->address }}
                            </p>
