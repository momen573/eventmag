    ...
    <div class="container">
      <form class="form" action="{{ route('shop.buy', ['type' => 'guest']) }}" method="POST"
        ...
        <div class="row">
            ...
            <div>
              <div id="couponReload">
                <ul class="package-summary mb-25">
                  ...
                  <li><span class="text">{{ __('Shipping Cost') }}</span> <span class="number"
                      dir="ltr">{{ $basicInfo->base_currency_symbol_position == 'left' ? $basicInfo->base_currency_symbol : '' }}
                      <span
                  ...
                  @if (Session::get('Shop_discount') != '')
                    <li><span class="text">{{ __('Discount') }}</span> <span class="number" dir="ltr">-
                        {{ $basicInfo->base_currency_symbol_position == 'left' ? $basicInfo->base_currency_symbol : '' }}
                  ...
                  <li><span class="text">{{ __('Grand Total') }}</span> <span class="number"
                      ...
                      <span class="grand_total"
                        dir="ltr">{{ $charge + $cartTotal - Session::get('Shop_discount') }}</span>
                      {{ $basicInfo->base_currency_symbol_position == 'right' ? $basicInfo->base_currency_symbol : '' }}</span>
                  </li>
                </ul>
              </div>
          ...
          @foreach ($online_gateways as $onlineGateway)
            @if ($onlineGateway->keyword == 'stripe')
              <div id="stripe-card-input" class="@if (
                ...
                <div class="form-group mb-4">
                  <input type="text" class="form-control" name="card_number"
                    placeholder="{{ __('Enter Your Card Number') }}" autocomplete="off"
                ...
                <div class="form-group mb-4">
                  <input type="text" class="form-control" name="cvc_number"
                    placeholder="{{ __('Enter CVC Number') }}" autocomplete="off" oninput="checkCVC(this.value)">
