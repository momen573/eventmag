                    ...
                    <div class="col-lg-4">
                      ...
                      <div class="form-group">
                        <input type="checkbox" name="pricing_type"
                          ...
                          class="" id="free_ticket"> <label for="free_ticket">Tickets are Free</label>
                      </div>
                    </div>
                  </div>
                            ...
                            <div class="col">
                              <div class="form-group {{ $language->direction == 1 ? 'rtl text-right' : '' }}">
                                ...
                                <textarea id="descriptionTmce{{ $language->id }}" class="form-control summernote" name="{{ $language->code }}_description"
                                  placeholder="Enter Event Description" data-height="300">{!! @$event_content->description !!}</textarea>
                              </div>
                            </div>
                          </div>
