              ...
              <form id="maintenanceForm" action="{{ route('admin.basic_settings.update_maintenance_mode') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <div class="thumb-preview">
                    @if (!empty($data->maintenance_img))
                      <img src="{{ asset('assets/admin/img/' . $data->maintenance_img) }}" alt="maintenance image" class="uploaded-img">
                    @else
                ...
                <div class="form-group">
                  ...
                  <p class="mt-2 mb-0 text-info">
                    ...
                    <span class="text-warning">http://localhost/coursela/token-value</span><br>
