              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input class="form-control" name="meta_keyword_home"
                    value="{{ $data != null ? $data->meta_keyword_home : '' }}" placeholder="Enter Meta Keywords"
                    data-role="tagsinput">
                </div>
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input class="form-control" name="meta_keyword_event"
                    value="{{ $data != null ? $data->meta_keyword_event : '' }}" placeholder="Enter Meta Keywords"
                    data-role="tagsinput">
                </div>

                <div class="form-group">
                  <label>{{ __('Meta Description For Events Page') }}</label>
                  <textarea class="form-control" name="meta_description_event" rows="5" placeholder="Enter Meta Description">{{ $data != null ? $data->meta_description_event : '' }}</textarea>
                </div>
              </div>
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input class="form-control" name="meta_keyword_organizer"
                    value="{{ $data != null ? $data->meta_keyword_organizer : '' }}" placeholder="Enter Meta Keywords"
                    data-role="tagsinput">
                </div>

                <div class="form-group">
                  <label>{{ __('Meta Description For Organizer Page') }}</label>
                  <textarea class="form-control" name="meta_description_organizer" rows="5" placeholder="Enter Meta Description">{{ $data != null ? $data->meta_description_organizer : '' }}</textarea>
                </div>
              </div>
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input class="form-control" name="meta_keyword_shop"
                    value="{{ $data != null ? $data->meta_keyword_shop : '' }}" placeholder="Enter Meta Keywords"
                    data-role="tagsinput">
                </div>

                <div class="form-group">
                  <label>{{ __('Meta Description For Shop Page') }}</label>
                  <textarea class="form-control" name="meta_description_shop" rows="5" placeholder="Enter Meta Description">{{ $data != null ? $data->meta_description_shop : '' }}</textarea>
                </div>
              </div>
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input class="form-control" name="meta_keyword_blog"
                    value="{{ $data != null ? $data->meta_keyword_blog : '' }}" placeholder="Enter Meta Keywords"
                    data-role="tagsinput">
                </div>
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input class="form-control" name="meta_keyword_faq"
                    value="{{ $data != null ? $data->meta_keyword_faq : '' }}" placeholder="Enter Meta Keywords"
                    data-role="tagsinput">
                </div>
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input class="form-control" name="meta_keyword_contact"
                    value="{{ $data != null ? $data->meta_keyword_contact : '' }}" placeholder="Enter Meta Keywords"
                    data-role="tagsinput">
                </div>
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input class="form-control" name="meta_keyword_about"
                    value="{{ $data != null ? $data->meta_keyword_about : '' }}" placeholder="Enter Meta Keywords"
                    data-role="tagsinput">
                </div>

                <div class="form-group">
                  <label>{{ __('Meta Description For About Us Page') }}</label>
                  <textarea class="form-control" name="meta_description_about" rows="5" placeholder="Enter Meta Description">{{ $data != null ? $data->meta_description_about : '' }}</textarea>
                </div>
              </div>
              ...
              <div class="col-lg-6">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" name="meta_description_customer_login" rows="5"
                    placeholder="Enter Meta Description">{{ $data != null ? $data->meta_description_customer_login : '' }}</textarea>
                </div>
              </div>
              ...
              <div class="col-lg-6">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" name="meta_description_customer_signup" rows="5"
                    placeholder="Enter Meta Description">{{ $data != null ? $data->meta_description_customer_signup : '' }}</textarea>
                </div>
              </div>
              ...
              <div class="col-lg-6">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" name="meta_description_organizer_login" rows="5"
                    placeholder="Enter Meta Description">{{ $data != null ? $data->meta_description_organizer_login : '' }}</textarea>
                </div>
              </div>
              ...
              <div class="col-lg-6">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" name="meta_description_organizer_signup" rows="5"
                    placeholder="Enter Meta Description">{{ $data != null ? $data->meta_description_organizer_signup : '' }}</textarea>
                </div>
              </div>
              ...
              <div class="col-lg-6">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" name="meta_description_customer_forget_password" rows="5"
                    placeholder="Enter Meta Description">{{ $data != null ? $data->meta_description_customer_forget_password : '' }}</textarea>
                </div>
              </div>
              ...
              <div class="col-lg-6">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" name="meta_description_organizer_forget_password" rows="5"
                    placeholder="Enter Meta Description">{{ $data != null ? $data->meta_description_organizer_forget_password : '' }}</textarea>
                </div>
              </div>
            </div>
          </div>
