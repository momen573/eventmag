                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="mail_subject" placeholder="Enter Mail Subject"
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="form-group">
                      ...
                      <textarea id="descriptionTmce1" class="form-control summernote" name="mail_body" placeholder="Enter Mail Body Format"
