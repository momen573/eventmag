...
@section('content')
  <div class="page-header">
    <h4 class="page-title">{{ __('PWA Scanner Setting') }}</h4>
    <ul class="breadcrumbs">
      ...
      <li class="nav-item">
        <a href="#">{{ __('PWA Settings') }}</a>
      </li>
      <li class="separator">
        <i class="flaticon-right-arrow"></i>
      </li>
      <li class="nav-item">
        <a href="#">{{ __('PWA Scanner Setting') }}</a>
      </li>
    </ul>
  </div>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="card">
        <form class="" action="{{ route('admin.pwa.scanner.update') }}" method="post"
          enctype="multipart/form-data">
          @csrf
          <div class="card-header">
            <div class="row">
              <div class="col-lg-12">
                <div class="card-title">{{ __('Update PWA Scanner Settings') }}</div>
              </div>
            </div>
          </div>
              ...
              <div class="col-lg-10 offset-lg-1">
                ...
                <div class="row">
                  <div class="col-xl-4">
                    <div class="form-group">
                      <div class="col-12 mb-2">
                        <label for="image"><strong> {{ __('Icon (128 X 128) **') }}</strong></label>
                      </div>
                      <div class="col-md-12 showImage mb-3">
                        <img src="{{ asset($pwa['icons'][0]['src']) }}" alt="..."
                          class="img-fluid">
                      </div>
                  ...
                  <div class="col-xl-4">
                    <div class="form-group">
                      <div class="col-12 mb-2">
                        <label for="image"><strong> {{ __('Icon (256 X 256) **') }}</strong></label>
                      </div>
                      <div class="col-md-12 showImage mb-3">
                        <img src="{{ asset($pwa['icons'][1]['src']) }}" alt="..."
                          class="img-fluid">
                      </div>
                  ...
                  <div class="col-xl-4">
                    <div class="form-group">
                      <div class="col-12 mb-2">
                        <label for="image"><strong> {{ __('Icon (512 X 512) **') }}</strong></label>
                      </div>
                      <div class="col-md-12 showImage mb-3">
                        <img src="{{ asset($pwa['icons'][2]['src']) }}" alt="..."
                          class="img-fluid">
                      </div>
