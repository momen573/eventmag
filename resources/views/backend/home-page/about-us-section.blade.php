              ...
              <form id="aboutUsForm" action="{{ route('admin.home_page.update_about_us_section', ['language' => request()->input('language')]) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <div class="thumb-preview">
                    @if (!empty($data->image))
                      <img src="{{ asset('assets/admin/img/about-us-section/' . $data->image) }}" alt="image" class="uploaded-img">
                    @else
                ...
                <div class="form-group">
                  ...
                  <textarea id="descriptionTmce1" class="form-control summernote"  name="text" placeholder="Enter About Us Section Text" rows="5">{{ empty($data->text) ? '' : $data->text }}</textarea>
                </div>
              </form>
            </div>
          </div>
