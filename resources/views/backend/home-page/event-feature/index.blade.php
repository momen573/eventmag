              ...
              <div class="col-lg-6 offset-lg-3">
                <form id="featureForm" action="{{ route('admin.home_page.update_event_feature_section') }}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="title" value="{{ empty($data->title) ? '' : $data->title }}" placeholder="Enter Event Feature Section Title">
                    @error('title')
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="text" value="{{ empty($data->text) ? '' : $data->text }}" placeholder="Enter Event Feature Section Text">
                    @error('text')
                      <p class="mt-2 mb-0 text-danger">{{ $message }}</p>
                    @enderror
                  </div>
