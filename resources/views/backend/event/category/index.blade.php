    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <div class="row">
            <div class="col-lg-4">
              <div class="card-title d-inline-block">{{ __('Event Categories') }}</div>
            </div>
          ...
          <div class="row">
            <div class="col-lg-12">
              @if (count($categories) == 0)
                <h3 class="text-center mt-2">{{ __('NO EVENT CATEGORY FOUND') . '!' }}</h3>
              @else
                      ...
                      @foreach ($categories as $category)
                        <tr>
                          ...
                          <td>
                            ...
                            @else
                              <h2 class="d-inline-block"><span class="badge badge-danger">{{ __('No') }}</span></h2>
                            @endif
                          </td>

                          <td>
                            <a class="btn btn-secondary mt-1 btn-xs mr-1 editBtn" href="#" data-toggle="modal"
                              data-target="#editEventCategoryModal" data-id="{{ $category->id }}"
