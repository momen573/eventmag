          ...
          <div class="row no-gutters">
            <div class="col-lg-6">
              <div class="form-group">
                ...
                <select id="in_events" class="select2" name="events[]" multiple="multiple" placeholder="Select Events">
                ...
                <p class="text-warning">{{ __('Please leave this field blank to make it applicable for all events') }}</p>
