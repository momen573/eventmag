  ...
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="ajaxForm" class="modal-form" action="{{ route('admin.payment_gateways.store_offline_gateway') }}"
          ...
          <div class="form-group">
            ...
            <textarea id="descriptionTmce1" class="form-control summernote" name="instructions" rows="3" cols="80"
              placeholder="Enter Gateway Instructions" data-height="150"></textarea>
          </div>
      ...
      <div class="modal-footer">
        ...
        <button id="submitBtn3" type="button" class="btn btn-primary">
          {{ __('Submit') }}
        </button>
      </div>
    </div>
