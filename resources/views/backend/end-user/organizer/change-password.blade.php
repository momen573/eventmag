...
@section('content')
  <div class="page-header">
    ...
    <ul class="breadcrumbs">
      ...
      <li class="nav-item">
        <a href="{{ route('admin.organizer_management.registered_organizer') }}">{{ __('Registered Organizers') }}</a>
      </li>
      <li class="separator">
        <i class="flaticon-right-arrow"></i>
      </li>
          ...
          <div class="row">
            <div class="col-lg-6 offset-lg-3">
              <form id="ajaxEditForm"
                action="{{ route('admin.organizer_management.organizer.update_password', ['id' => $userInfo->id]) }}"
                method="post">
                @csrf
