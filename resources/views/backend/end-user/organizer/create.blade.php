        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-8 mx-auto">
              ...
              <form id="eventForm" action="{{ route('admin.organizer_management.save-organizer') }}" method="post">
                @csrf
                <div class="row">
                  <div class="col-lg-12">
                  ...
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <input type="text" value="" class="form-control" name="email" placeholder="Enter Email">
                                ...
                                <div class="col-lg-4">
                                  <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"
                                      name="{{ $language->code }}_designation" value="">
