              ...
              <div class="row align-items-center">
                ...
                <div class="col col-stats ml-3 ml-sm-0">
                  <div class="numbers mx-auto text-center">
                    ...
                    <p class="card-category"><strong>{{ __('Total') }}:</strong> {{ $digital_product }}
                      {{ $digital_product > 1 ? 'Items' : 'Item' }}</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="row align-items-center">
                ...
                <div class="col col-stats ml-3 ml-sm-0">
                  <div class="numbers mx-auto text-center">
                    ...
                    <p class="card-category"><strong>{{ __('Total') }}:</strong> {{ $physical_product }}
                      {{ $physical_product > 1 ? 'Items' : 'Item' }}</p>
                  </div>
                </div>
              </div>
            </div>
