                  ...
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <select name="status" class="form-control">
                        ...
                        <option {{ $product->status == 0 ? 'selected' : '' }} value="0">{{ __('Deactive') }}
                        </option>
                      </select>
                    </div>
                  </div>
                    ...
                    @if ($product->type == 'digital')
                      <div class="form-group">
                        ...
                        <select name="file_type" class="form-control" id="fileType">
                          <option {{ $product->file_type == 'upload' ? 'selected' : '' }} value="upload" selected>File
                            Upload</option>
                          <option {{ $product->file_type == 'link' ? 'selected' : '' }} value="link">File Download
                            Link
                          </option>
                        </select>
                  ...
                  @if ($product->type == 'digital')
                    <div class="col-lg-6">
                      <div id="downloadFile" class="form-group {{ $product->file_type == 'upload' ? '' : 'd-none' }}">
                        ...
                        <p id="errdownload_file" class="mb-0 text-danger em">File Name: {{ $product->download_file }}
                        </p>
                      </div>
                            ...
                            <div class="col">
                              <div class="form-group {{ $language->direction == 1 ? 'rtl text-right' : '' }}">
                                ...
                                <textarea name="{{ $language->code }}_summary" id="summary" class="form-control" rows="4"
                                  placeholder="Enter Product Summary">{{ @$product_content->summary }}</textarea>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col">
                              <div class="form-group {{ $language->direction == 1 ? 'rtl text-right' : '' }}">
                                ...
                                <textarea id="descriptionTmce{{ $language->id }}" class="form-control summernote" name="{{ $language->code }}_description"
                                  placeholder="Enter Product Description" data-height="300">{!! @$product_content->description !!}</textarea>
                              </div>
                            </div>
                          </div>
                            ...
                            <div class="col">
                              <div class="form-group {{ $language->direction == 1 ? 'rtl text-right' : '' }}">
                                ...
                                <input class="form-control" name="{{ $language->code }}_meta_keywords"
                                  value="{{ @$product_content->meta_keywords }}" placeholder="Enter meta keywords"
                                  data-role="tagsinput">
                              </div>
                            </div>
                          </div>
                            ...
                            <div class="col">
                              <div class="form-group {{ $language->direction == 1 ? 'rtl text-right' : '' }}">
                                ...
                                <textarea class="form-control" name="{{ $language->code }}_meta_description" rows="5"
                                  placeholder="Enter meta description">{{ @$product_content->meta_description }}</textarea>
                              </div>
                            </div>
                          </div>
