                ...
                <div class="row ">
                  ...
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <input type="number" name="current_price" placeholder="Enter Current Price" class="form-control">
                    </div>
                  </div>
                  <div class="col-lg-6">
                    <div class="form-group">
                      <label>{{ __('Previous Price') . '*' }}</label>
                      <input type="number" name="previous_price" placeholder="Enter Previous Price" class="form-control">
                    </div>
                  </div>
                            ...
                            <div class="col">
                              <div class="form-group {{ $language->direction == 1 ? 'rtl text-right' : '' }}">
                                ...
                                <textarea id="descriptionTmce{{ $language->id }}" class="form-control summernote"
                                  name="{{ $language->code }}_description" placeholder="Enter Product Description" data-height="300"></textarea>
                              </div>
                            </div>
                          </div>
                            ...
                            <div class="col">
                              <div class="form-group {{ $language->direction == 1 ? 'rtl text-right' : '' }}">
                                ...
                                <input type="text" class="form-control" name="{{ $language->code }}_tags"
                                  value="" data-role="tagsinput" placeholder="Enter tags">
