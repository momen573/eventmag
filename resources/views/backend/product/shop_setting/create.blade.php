  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="modalForm" class="modal-form create" action="{{ route('admin.shop_management.store_shipping') }}" method="post" enctype="multipart/form-data">
          @csrf
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="text" placeholder="Enter Short Text">
            <p id="err_text" class="mt-1 mb-0 text-danger em"></p>
          </div>

          <div class="form-group">
            <label for="">{{ __('Charge (NGN)') . '*' }}</label>
