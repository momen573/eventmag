  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="ajaxEditForm" class="modal-form" action="{{ route('admin.shop_management.update_coupon') }}" method="post">
          ...
          <div class="row no-gutters">
            ...
            <div class="col-lg-6">
              <div class="form-group">
                ...
                <input type="text" id="in_code" class="form-control" name="code" placeholder="Enter Code">
            ...
            <div class="col-lg-6">
              <div class="form-group">
                ...
                <input type="text" id="in_value" class="form-control" name="value" placeholder="Enter Value">
            ...
            <div class="col-lg-6">
              <div class="form-group">
                ...
                <input type="text" id="in_minimum_spend" class="form-control" name="minimum_spend" placeholder="Enter Minimum Spend">
