      ...
      <div class="modal-body">
        <form id="ajaxForm" class="modal-form create" action="{{ route('admin.withdraw_payment_method.store') }}"
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="name" placeholder="Enter Method Name">
          ...
          <div class="form-group">
            ...
            <input type="number" class="form-control" name="min_limit" placeholder="Enter Withdraw Minimum Limit">
            <p id="err_min_limit" class="mt-1 mb-0 text-danger em"></p>
          </div>

          <div class="form-group">
            <label for="">{{ __('Maximum Limit') . '*' }} ({{ $settings->base_currency_text }})</label>
            <input type="number" class="form-control" name="max_limit" placeholder="Enter Withdraw Maximum Limit">
            <p id="err_max_limit" class="mt-1 mb-0 text-danger em"></p>
          </div>

          <div class="form-group">
            <label for="">{{ __('Fixed Charge') }} ({{ $settings->base_currency_text }})</label>
            <input type="number" class="form-control" name="fixed_charge" placeholder="Enter Fixed Charge">
            <p id="err_fixed_charge" class="mt-1 mb-0 text-danger em"></p>
          </div>

          <div class="form-group">
            <label for="">{{ __('Percentage Charge') }}</label>
            <input type="number" class="form-control" name="percentage_charge" placeholder="Enter Percentage Charge">
