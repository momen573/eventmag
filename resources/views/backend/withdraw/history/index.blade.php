                        ...
                        <tr>
                          ...
                          <td>
                            <a href="javascript:void(0)" data-toggle="modal"
                              data-target="#withdrawModal{{ $item->id }}" class="btn btn-primary mt-1 btn-xs"><span
                                class="btn-label">
                                <i class="fas fa-eye"></i>
                              </span> {{ __('View') }}</a>
                            @if ($item->status == 0)
                              <a href="{{ route('admin.witdraw.approve_withdraw', ['id' => $item->id]) }}"
                                class="btn btn-success mt-1 btn-xs  confirmBtn"><span class="btn-label">
                                  <i class="fas fa-check-circle"></i>
                                </span> {{ __('Approve') }}</a>
                              <a href="{{ route('admin.witdraw.decline_withdraw', ['id' => $item->id]) }}"
                                class="btn btn-warning mt-1 btn-xs confirmBtn"><span class="btn-label">
